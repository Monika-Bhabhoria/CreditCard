...
class DataTransformation:
    ...
    def get_data_transformation(self):
        ...
        try:
            ...
            #update data type done in data ingestion
            
            
            # Define which columns should be ordinal-encoded and which should be scaled
            categorical_cols = ['SEX', 'EDUCATION', 'MARRIAGE', 'PAY_1', 'PAY_2', 'PAY_3', 'PAY_4',
       'PAY_5', 'PAY_6']
            numerical_cols = ['ID', 'LIMIT_BAL', 'AGE', 'BILL_AMT1', 'BILL_AMT2', 'BILL_AMT3',
